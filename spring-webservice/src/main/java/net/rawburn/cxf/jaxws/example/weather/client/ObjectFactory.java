...
package net.rawburn.cxf.jaxws.example.weather.client;
 ...
 * generated in the net.rawburn.cxf.jaxws.example.weather.client package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.rawburn.cxf.jaxws.example.weather.client
     * 
     */
